...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, TransactionNotificationDTO> producerFactory() {
        ...
        // Se quiser compatibilidade com consumer sem headers de tipo
    ...
    // Consumer beans (para uso no mesmo serviço, se necessário)
    @Bean
    public ConsumerFactory<String, TransactionNotificationDTO> transactionConsumerFactory(){
        ...
        // ErrorHandlingDeserializer delega para JsonDeserializer
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
        props.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JsonDeserializer.class);
        // tipo padrão quando o produtor não envia headers de tipo
        ...
        JsonDeserializer<TransactionNotificationDTO> valueDeserializer = new JsonDeserializer<>(TransactionNotificationDTO.class);
        valueDeserializer.addTrustedPackages("com.grupo5.payment_platform.Infra.Kafka");
