...
//Ao estender essa classe, precisamos implementar o metodo doFilterInternal
@Component
public class SecurityFilter extends OncePerRequestFilter {

    //Injeções de dependencia via construtor
    ...
    //Metodo obrigatorio de ser implementado da classe OncePerRequestFilter
    //Responsavel por filtrar as requisições
    @Override
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (login != null){
            UserModel user = userRepository.findByEmail(login).orElseThrow(() -> new RuntimeException("Usuario nao encontrado"));
